...
class _StatsPageState extends State<StatsPage> with TickerProviderStateMixin {
  ...
  // late Stream<double> batteryVoltageStream;
  late Stream<double> solarVoltageStream;
      ...
      if (Provider.of<StateHandler>(context, listen: false).currentGarden !=
        ...
        pumpStreamController.sink.add(
            Provider.of<StateHandler>(context, listen: false)
                .currentGarden!
                .pump);
        // batteryVoltageStreamController.sink.add(
        //     Provider.of<StateHandler>(context, listen: false)
        //         .currentGarden!
        //         .batteryVoltage);
        solarVoltageStreamController.sink.add(
            Provider.of<StateHandler>(context, listen: false)
                .currentGarden!
                .solarVoltage);
  ...
  void initState() {
    ...
    // batteryVoltageStreamController = StreamController();
    solarVoltageStreamController = StreamController();
    ...
    // batteryVoltageStream =
    //     batteryVoltageStreamController.stream.asBroadcastStream();
    solarVoltageStream =
        solarVoltageStreamController.stream.asBroadcastStream();
    ...
    // batteryVoltageStream.listen((event) {
    //   setState(() {
    //     batteryVoltage = event;
    //   });
    // });
  ...
  void dispose() {
    ...
    // batteryVoltageStreamController.close();
    solarVoltageStreamController.close();
                                  ...
                                  RadialAxis(
                                      ...
                                      ranges: [
                                        ...
                                        GaugeRange(
                                          ...
                                          gradient: SweepGradient(
                                            colors: [
                                              Color.fromARGB(255, 238, 193, 13),
                                              Color.fromARGB(255, 237, 89, 3),
                                            ],
                                          ),
                                        ),
                                      ],
