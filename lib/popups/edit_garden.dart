...
class EditGarden extends StatefulWidget {
  final Garden garden;
  const EditGarden({Key? key, required this.garden}) : super(key: key);
...
class _EditGardenState extends State<EditGarden> {
  TextEditingController gardenName = new TextEditingController();

  @override
  void initState() {
    super.initState();
    gardenName = TextEditingController(text: widget.garden.name);
  }
                ...
                onPressed: () async {
                  ...
                  if (kDebugMode) {
                    Fluttertoast.showToast(
                      msg: "New name: " + gardenName.value.toString(),
